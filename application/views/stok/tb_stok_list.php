        ...
        <div class='col-xs-12'>
            <div class='box'>
                <div class='box-header'>
                    ...
                    <?= anchor(site_url('tb_stok/pdf'), '<i class="fa fa-file-pdf-o"></i> PDF', 'class="btn btn-sm btn-round btn-warning btn-sm" target="_blank"'); ?>
                    <?= anchor(site_url('tb_stok/excel'), ' <i class="fa fa-file-excel-o"></i> Excel', 'class="btn btn-round btn-primary btn-sm"'); ?>

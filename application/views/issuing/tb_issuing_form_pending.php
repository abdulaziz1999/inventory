                          ...
                          foreach ($b_pending->result() as $issuing)
                          {
                              ?>
                                <tr>
                                    ...
                                    <td><?= "Rp. ".rupiah($issuing->jumlah*$issuing->harga_jual) ?></td>
                                    <td>
                                        <a href="#" class="btn btn-sm btn-primary" id="click" data-toggle="modal" data-target="#myModalEdit" onclick="updateJml(<?= @$issuing->id_pendings?>)"><i class="fa fa-pencil"></i> Edit</a>

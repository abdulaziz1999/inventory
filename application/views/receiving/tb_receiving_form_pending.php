                            ...
                            foreach ($b_receiving->result() as $tb_receiving)
                            {
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <span class="label label-lg label-success arrowed">Sudah di Approve</span>
                                        </td>
                                    </tr>
                                    <?php
                            }
                            ...
                            <?php $start = 0; foreach ($b_pending->result() as $tb_receiving)
                            {
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group btn-corner">
                                            <a href="#" class="btn btn-round btn-sm btn-primary" id="click" data-toggle="modal" data-target="#myModalEdit" onclick="updateJml(<?= @$tb_receiving->id_pending?>)"><i class="fa fa-pencil"></i> Edit</a>

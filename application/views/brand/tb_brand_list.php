        ...
        <div class='col-xs-12'>
            <div class='box'>
                <div class='box-header'><br>
                    <?php echo anchor('tb_brand/create/','<i class="fa fa-plus"></i> Tambah',array('class'=>'btn btn-sm btn-round btn-primary btn-sm'));?>
                    ...
                    <h3 class="table-header text-center"><strong>Tabel Brand Barang</strong></h3>
                </div><!-- /.box-header -->
                <div class='box-body'>
